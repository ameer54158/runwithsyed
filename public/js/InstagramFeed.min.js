...
(function (a, b) {
    ...
    function f(a, b, c, d, g, h) {
        var i;
        g && h && (i = "https://images" + ~~(3333 * Math.random()) + "-focus-opensocial.googleusercontent.com/gadgets/proxy?container=none&url=" + a);
        var j = new XMLHttpRequest;
        j.onload = function () {
            4 === j.readyState && 200 === j.status && (data = e(b, j.responseText), !1 === data ? d(!1) : d(data))
        }, j.onerror = function (i) {
            1 < c ? (console.warn("Instagram Feed: Request failed, " + (c - 1) + " tries left. Retrying..."), f(a, b, c - 1, d, g, !h)) : d(!1, i)
        }, j.open("GET", i || a, !0), j.send()
    }
    ...
    function h(c, d) {
        ...
        if (c.styling) {
            ...
            e = {
                ...
                gallery_image_link: " style=\"width:" + g + "%; margin:" + c.margin + "%;position:relative; display: inline-block; height: 100%;\""
            }, c.display_captions && (f += "<style>                    a[data-caption]:hover::after {                        content: attr(data-caption);                        text-align: center;                        font-size: 0.8rem;                        color: black;                        position: absolute;                        left: 0;                        right: 0;                        bottom: 0;                        padding: 1%;                        max-height: 100%;                        overflow-y: auto;                        overflow-x: hidden;                        background-color: hsla(0, 100%, 100%, 0.8);                    }                </style>")
        } else e = {
            profile_container: "",
            profile_image: "",
            profile_name: "",
        ...
        if (c.display_profile && "userid" !== c.type && (f += "<div class=\"instagram_profile\"" + e.profile_container + ">", f += "<img class=\"instagram_profile_image\" src=\"" + d.profile_pic_url + "\" alt=\"" + ("tag" == c.type ? d.name + " tag pic" : d.username + " profile pic") + "\"" + e.profile_image + (c.lazy_load ? " loading=\"lazy\"" : "") + " />", "tag" == c.type ? f += "<p class=\"instagram_tag\"" + e.profile_name + "><a href=\"https://www.instagram.com/explore/tags/" + c.tag + "/\" rel=\"noopener\" target=\"_blank\">#" + c.tag + "</a></p>" : "username" == c.type ? (f += "<p class='instagram_username'" + e.profile_name + ">@" + d.full_name + " (<a href='https://www.instagram.com/" + c.username + "/' rel='noopener' target='_blank'>@" + c.username + "</a>)</p>", c.display_biography && (f += "<p class='instagram_biography'" + e.profile_biography + ">" + d.biography + "</p>")) : "location" == c.type && (f += "<p class='instagram_location'" + e.profile_name + "><a href='https://www.instagram.com/explore/locations/" + c.location + "/' rel='noopener' target='_blank'>" + d.name + "</a></p>"), f += "</div>"), c.display_gallery) if ("undefined" != typeof d.is_private && !0 === d.is_private) f += "<p class=\"instagram_private\"><strong>This profile is private</strong></p>"; else {
            ...
            for (var m = 0; m < l; m++) {
                ...
                f += "<a href=\"" + p + "\"" + (c.display_captions ? " data-caption=\"" + q + "\"" : "") + " class=\"instagram-" + o + "\" rel=\"noopener\" target=\"_blank\"" + e.gallery_image_link + ">", f += "<img" + (c.lazy_load ? " loading=\"lazy\"" : "") + " src=\"" + n + "\" alt=\"" + q + "\"" + e.gallery_image + " />", f += "</a>"
            }
            f += "</div>"
        }
        if (c.display_igtv && "undefined" != typeof d.edge_felix_video_timeline) {
            var r = d.edge_felix_video_timeline.edges, l = r.length > c.items ? c.items : r.length;
            if (0 < r.length) {
                f += "<div class=\"instagram_igtv\">";
                for (var m = 0; m < l; m++) {
                    var p = "https://www.instagram.com/p/" + r[m].node.shortcode, q = b(r[m], d);
                    !1 === q && (q = ("userid" == c.type ? "" : c.id) + " image"), q = a(q), f += "<a href=\"" + p + "\"" + (c.display_captions ? " data-caption=\"" + q + "\"" : "") + " rel=\"noopener\" target=\"_blank\"" + e.gallery_image_link + ">", f += "<img" + (c.lazy_load ? " loading=\"lazy\"" : "") + " src=\"" + r[m].node.thumbnail_src + "\" alt=\"" + q + "\"" + e.gallery_image + " />", f += "</a>"
                }
                f += "</div>"
            }
        }
    ...
    }, j = {150: 0, 240: 1, 320: 2, 480: 3, 640: 4}, k = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
        '"': "&quot;",
