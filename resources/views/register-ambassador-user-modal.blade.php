<div class="modal fade" id="registerambassadormodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('register') }}" autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        @endif
                        <h5 class="title">{{__('register.register-as-an-ambassador')}}</h5>
                        <p class="description">{{__('register.register-ambassador-form-description')}}</p>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row my-3 form-check ml-1">
                        <label class="form-check-label" for="inlineFormCheck" style="font-size: 14px">
                            <input class="form-check-input" type="checkbox" id="inlineFormCheck" name="accept_all_terms" checked required>
                            {!! __('register.terms and conditions') !!}
                        </label>
                    </div>
                    <div class="form-row d-flex justify-content-center mt-4">
                        <button class="btn" type="submit" name="register-button" value="ambassador-button">{{__('register.become-ambassador-btn')}}</button>
                    </div>
                </form>
            </div>
        </div>
