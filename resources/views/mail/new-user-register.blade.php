        ...
        <div style="min-height: 350px;" class="row">
            <div class="col-md-6 offset-md-3 text-center align-self-center">
                <div class="">
                    ...
                    <p>
                        Vi ønsker deg velkommen på <strong><a style="text-decoration: none" href="{{ url('/')}}">runwithsyed</a></strong>. En ny <strong>{{$user->hasRole('ambassador') ? 'ambassadør' : 'sponsor'}}</strong> konto er opprettet på <strong><a style="text-decoration: none" href="{{ url('/')}}">runwithsyed</a></strong> ved hjelp av <strong>{{$user->email}}</strong> e-post.
                    </p>
                    <p>
