        ...
        <div style="min-height: 350px;" class="row">
            <div class="col-md-6 offset-md-3 text-center align-self-center">
                <div class="">
                    ...
                    @if($become_ambassador_status == 'active')
                        <p>
                            Vi vil informere deg om at <strong>{{$sponsor_user_name}}</strong> vil nå sponse ambassadøren <strong>{{$ambassador_user_name}}</strong>.
                        </p>
                        <p>
                            Informasjon til sponsor:<br>
                            Vi ønsker deg velkommen på <a style="text-decoration: none" href="{{url('/')}}">runwithsyed</a>.
                        </p>
                        <p>
                        ...
                        <p>
                            For deg som ambassadør vil du være en frontfigurer for foreningen. Andre medlemmer vil ha muligheten til å gi donasjoner på bakgrunn av de kilometerne du har lagt bak deg. Vi er stolte å ha deg som medlem! Som ambassadør, vil det også komme et kontingent på kr {{isset($setting_obj) && $setting_obj->get_value('ambassador_membership_fee') ? $setting_obj->get_value('ambassador_membership_fee') : 200}}. Denne kontingenten vil utelukkende gå til
                    ...
                    @if($become_ambassador_status == 'deactivate')
                        <p>
                            Vi vil informere deg om at <strong>{{$sponsor_user_name}}</strong> ikke lenger sponser ambassadøren <strong>{{$ambassador_user_name}}</strong>.
                        </p>
                    @endif
