<div class="modal fade ambassador-pay-modal" id="pay_amount_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('ambassador-pay-amount')}}" method="POST" autocomplete="off" class="pay-amount-form">
                @csrf
                <input class="tab_type" name="tab_type" type="hidden" value="register_km">
                <div class="modal-body">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>{{__('profile.enter amount you want to pay')}}:</label>
                            <input type="number" class="form-control amount" name="amount" placeholder="{{__('profile.enter amount you want to pay')}}" value="" required min="1" onkeydown="if(event.key==='-' || event.key==='+' || event.key==='.'){event.preventDefault();}">
